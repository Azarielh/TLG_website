...
export default function About() {
  return (
      <main class="relative z-10 flex flex-col items-center justify-center py-12 px-6">
        ...
        <div class="flex flex-col md:flex-row flex-wrap justify-center items-stretch gap-6 w-full">
          <article class="bg-gray-800/60 border border-gray-700 rounded-2xl p-6 shadow-lg flex-1 min-w-[18rem] md:max-w-[30%] hover:translate-y-[-4px] transition-transform">
