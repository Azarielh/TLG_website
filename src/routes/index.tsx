    ...
    <main id="home">
      ...
      <MainLogo />
        ...
        <div class="pagepanel mx-auto w-[65vw] max-w-[1500px] flex-1 min-h-[40vh] md:min-h-[60vh] h-[calc(100vh-20rem)] relative overflow-hidden flex items-center justify-center p-6">
          ...
          La haut, vous avez une phrase qui en jette, elle bougera de temps en temps et on pourra même faire des variations, là bas, c'est un coffre, parce que c'est bien les bien, ouais, j'aime bien les coffres, et là juste ici, des images qui bouge tout le temps qui mette de l'animation qui rendent le site vivant.
          Ouais...Ce sera bien ! Ce sera vraiment bien... Je reviens dans 1mois avec de la potion magique...peut être.
              </p>
            </div>
          </div>
        </div>
