...
export default function Home() {
  ...
  return (
    <main id="home" class="pt-20 pb-32 px-4">
      ...
      <div class="fixed top-24 right-4 z-40 flex flex-col gap-2">
        <button 
          onClick={() => setLayout('classic')}
          class={`px-4 py-2 rounded-lg font-bold transition-all duration-300 ${layout() === 'classic' ? 'bg-yellow-400 text-black' : 'bg-gray-800/80 text-gray-400 hover:bg-gray-700'}`}
        ...
        <button 
          ...
          class={`px-4 py-2 rounded-lg font-bold transition-all duration-300 ${layout() === 'split' ? 'bg-yellow-400 text-black' : 'bg-gray-800/80 text-gray-400 hover:bg-gray-700'}`}
        ...
        <button 
          ...
          class={`px-4 py-2 rounded-lg font-bold transition-all duration-300 ${layout() === 'compact' ? 'bg-yellow-400 text-black' : 'bg-gray-800/80 text-gray-400 hover:bg-gray-700'}`}
