	...
	return (
        ...
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex gap-2.5 items-center whitespace-nowrap">
          <SessionStatus text="Section à venir" placement="bottom">
            <a class="text-[rgb(156,163,175)] px-3 py-2 rounded-[10px] transition-all duration-150 border border-transparent bg-transparent font-semibold hover:text-white hover:bg-[rgba(147,51,234,0.12)] hover:border-[rgba(168,85,247,0.18)]" href="/about">Qui sommes-nous ?</a>
          </SessionStatus>
          <SessionStatus text="Section à venir" placement="bottom">
          ...
          <SessionStatus text="Section à venir" placement="bottom">
            <a class="text-[rgb(156,163,175)] px-3 py-2 rounded-[10px] transition-all duration-150 border border-transparent bg-transparent font-semibold hover:text-white hover:bg-[rgba(147,51,234,0.12)] hover:border-[rgba(168,85,247,0.18)]" href="/contact">Partenaires</a>
          </SessionStatus>
          <SessionStatus text="Section à venir" placement="bottom">
